...
#
# Run: nix eval --file learn/03-lists.nix
#
# ──────────────────────────────────────────────────────────────────────────────

{
  ...
  # From phix — this is how substituters are defined:
  # See: modules/common/nix.nix:28
  ...
  # This pattern is everywhere in phix. See: modules/home/packages.nix:24
  #
  ...
  #
  # You'll see this constantly in phix. The pattern:
  #
  ...
  # See: modules/home/packages.nix:24 and lib/default.nix:28 (WSL modules).
